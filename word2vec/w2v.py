...
# 用jieba进行分词
comment = open('./croups/comment.txt').read()
...
# 分完词的文件写到新的txt中去
fo = open("./croups/afterSeg.txt","w",encoding='utf-8')
fo.write(comment)
print("finished!")
fo.close()

sentences=word2vec.Text8Corpus(u'./croups/afterSeg.txt')
...
#http://www.cnblogs.com/n2meetu/p/8124267.html