...
def get_result():
    ...
    print("CBC  MLP  acc is %d---%d",np.mean(acc_data),np.std(acc_data))
    #print("CBC std acc is:",acc_std)
    print("CBC  MLP sen is %d---%d",np.mean(sen_data),np.std(sen_data))
    #print("CBC std sen is:",sen_std)
    print("CBC  MLP spe is %d---%d",np.mean(spe_data),np.std(spe_data))
    #print("CBC std spe is:",spe_std)
    print("CBC  MLP auc is %d---%d",np.mean(auc_data),np.std(auc_data))
