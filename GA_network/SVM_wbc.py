...
def get_data():
    ...
    x_train, x_test,y_train, y_test = train_test_split(csv_data, data_y, test_size=0.8, random_state=random.randint(0,100))
...
clf0 = GridSearchCV(SVC(kernel='rbf', class_weight='balanced'), param_grid)
clf0 = clf0.fit(X_train, y_train)
print('The accuracy of SVM Classifier is',clf0.score(X_test,y_test))
