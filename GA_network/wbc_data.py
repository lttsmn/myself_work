...
def get_result_wbc():
    ...
    print("wbc MLT  acc is %d---%d",np.mean(acc_data),np.std(acc_data))
    #print("CBC std acc is:",acc_std)
    print("wbc  MLT sen is %d---%d",np.mean(sen_data),np.std(sen_data))
    #print("CBC std sen is:",sen_std)
    print("wbc  MLT spe is %d---%d",np.mean(spe_data),np.std(spe_data))
    #print("CBC std spe is:",spe_std)
    print("wbc  MLT auc is %d---%d",np.mean(auc_data),np.std(auc_data))


    print("wbc  KNN acc is %f---%f",np.mean(knn_acc),np.std(knn_acc))
    #print("CBC std acc is:",acc_std)
    print("wbc  KNN sen is %f---%f",np.mean(knn_sen),np.std(knn_sen))
    #print("CBC std sen is:",sen_std)
    print("wbc  KNN spe is %f---%f",np.mean(knn_spe),np.std(knn_spe))
    #print("CBC std spe is:",spe_std)
    print("wbc  KNN auc is %f---%f",np.mean(knn_auc),np.std(knn_auc))


    print("wbc  SVM acc is %f---%f",np.mean(svm_acc),np.std(svm_acc))
    #print("CBC std acc is:",acc_std)
    print("wbc  SVM sen is %f---%f",np.mean(svm_sen),np.std(svm_sen))
    #print("CBC std sen is:",sen_std)
    print("wbc  SVM spe is %f---%f",np.mean(svm_spe),np.std(svm_spe))
    #print("CBC std spe is:",spe_std)
    print("wbc  SVM auc is %f---%f",np.mean(svm_auc),np.std(svm_auc))



    print("wbc  NB acc is %f---%f",np.mean(nb_acc),np.std(nb_acc))
    #print("CBC std acc is:",acc_std)
    print("wbc  NB sen is %f---%f",np.mean(nb_sen),np.std(nb_sen))
    #print("CBC std sen is:",sen_std)
    print("wbc  NB spe is %f---%f",np.mean(nb_spe),np.std(nb_spe))
    #print("CBC std spe is:",spe_std)
    print("wbc  NB auc is %f---%f",np.mean(nb_auc),np.std(nb_auc))
